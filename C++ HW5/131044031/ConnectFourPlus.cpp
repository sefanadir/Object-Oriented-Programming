...
namespace sefanadir {
    ...
    ConnectFourPlus::ConnectFourPlus(const ConnectFourPlus& object) {
        setPlayer(true);
    ...
    void ConnectFourPlus::playUser1User2() {
        ...
        while (game) {
            ...
            if (checkHorizontal() >= FOUR || checkVertical() >= FOUR) {
                game = false;
                cout << endl;
    ...
    void ConnectFourPlus::playComputerUser() {
